...
```html
<a href=https://youtu.be/{video_id}><img src=https://markdown-videos.deta.dev/youtube/{video_id}></a></img>
```

#### example

```html
<a href=https://youtu.be/WHyOHQ_GkNo><img src=https://markdown-videos.deta.dev/youtube/WHyOHQ_GkNo></a></img>
```
